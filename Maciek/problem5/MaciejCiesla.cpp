...
// add integers at the end of the vector
	...
	cout << "Suma elementow o wartosci 9: " << count(v.begin(), v.end(), 9)*9 <<endl;
...
//============================================================
	...
	cout << "Suma elementów o wartości 9: " << count(s.begin(), s.end(), 9)*9 <<endl;
...
cout << "Zadanie C" << endl << endl;
	...
	mp.erase(mp.begin());
    	...
    	pair <int, string> begin = *mp.begin();
    	it_mp = ++mp.begin();
    	mp.insert(begin);
    	mp.insert(*it_mp);
	...
	mp.erase(3);
	cout << "Element o najmniejszej wartosci: "<< endl << "[" << (*min_element(mp.begin(), mp.end())).first << " - " << (*min_element(mp.begin(), mp.end())).second << "]" << endl;
